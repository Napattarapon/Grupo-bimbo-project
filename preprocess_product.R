...
product_data <- read.csv('C:/Users/terte/Desktop/R/Project02/productSmp.csv')
preprocessed <- preprocess_products(product_data)
write.csv(preprocessed, 'C:/Users/terte/Desktop/R/Project02/preprocessed_products.csv')

## Ref https://www.kaggle.com/lyytinen/basic-preprocessing-for-products