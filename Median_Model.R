...
train <- fread('C:/Users/terte/Desktop/R/Project02/trainSmp.csv', 
...
##-------------------------
test <- fread('C:/Users/terte/Desktop/R/Project02/testSmp.csv', 
...
write.csv(submit[,.(id,Demanda_uni_equil)],"C:/Users/terte/Desktop/R/Project02/Result/submit.csv", row.names = FALSE)

###https://www.kaggle.com/nigelcarpenter/r-medians